...
public class VormerkWerkzeug
{
     ...
     */
    private boolean istVormerkungMoeglich() //da den service aufrufen
    {
        ...
        boolean vormerkenMoeglich = (kunde != null) && !medien.isEmpty() && 
        	_verleihService.istVomerkungMoeglich(kunde, medien);
    ...
    {
        boolean istVormerkenMoeglich = istVormerkungMoeglich();
        _vormerkUI.getVormerkenButton()
