...
public class VormerkMedienauflisterWerkzeug extends ObservableSubWerkzeug
{
    ...
    private void setzeAnzuzeigendeMedien()
    {
        ...
        for (Medium medium : medienListe)
        {
            ...
            Kunde entleiher = _verleihService.getEntleiherFuerVormerken(medium);
            Kunde vormerker1 = _verleihService.gibVormerkkarte(medium).gibKundeByIndex(0);
            Kunde vormerker2 = _verleihService.gibVormerkkarte(medium).gibKundeByIndex(1);
            Kunde vormerker3 = _verleihService.gibVormerkkarte(medium).gibKundeByIndex(2);
