...
public interface VerleihService extends ObservableService
{
    ...
    /**
    * Merkt Kunden für ein Medium vor. 
    * Dabei wird für jedes Medium eine neue Vormerkkarte angelegt.
    * 
    * @param kunde Ein Kunde, der vorgemerkt werden soll
    * @param medien Die Medien, für die vorgemerkt werden sollen
    * 

    * @require kundeImBestand(kunde)
    * @require medienImBestand(List<Medium>)
    * 
    **/        
    void merkeVor(Kunde kunde, List<Medium> medien);
    
    /**
    * Gibt die Stelle an welcher Position der Kunde vorgemerkt ist
    *
    * @param kunde Der Kunde
    * @param vormerkkarte Die Vormerkkarte
    *
    * @require kundeImBestand(kunde)
    * @require vormerkkarte != null
    *
    * @return die Position des Kunden in der Warteschlange
    *
	* int gibVormerkungsNummer(Kunde kunde, Vormerkkarte vormerkkarte);
	**/

	/**
	* Gibt die Vormerkkarte für das Medium zurück.
	*
	...
	**/
	...
	/**
	* Gibt den Kunden zurück, der sich an einer gewissen Position in der Warteschlange befindet
	*
	* @param i Der Index
	*
	* @require i >= 0 && i < 3
	*
	* @return Der Kunde beim jeweiligen Index
	**/
	Kunde gibKundeByIndex(int i, Medium medium);
    ...
    *
    * @return true, wenn das Vormerken für diesen Kunden möglich ist, sonst false
    *
    * @require kundeImBestand(kunde)
    * @require medienImBestand(List<Medium>)
    *
	**/
	boolean istVomerkungMoeglich(Kunde kunde, List<Medium> medium);
    ...
    /**
     * Liefert den Entleiher des angegebenen Mediums, falls es diesen gibt. Ansonsten null
     * 
     * @param medium Das Medium.
     * 
     * @return Den Entleiher des Mediums.
     ...
     * @ensure result != null
     */
    Kunde getEntleiherFuerVormerken(Medium medium);
    ...
    /**
    * Entfernt zuvor vorgemerkten Kunden von der Vormerkkarte
    * 
    * @param kunde der Kunde 
    * @param medien die Medien
    *
    ...
    * @require medienImBestand(List<Medium>)
    **/
    void entferneVormerkung(Kunde kunde, List<Medium> mediem);
